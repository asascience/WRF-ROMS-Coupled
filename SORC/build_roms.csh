#!/bin/csh -f
#
# svn $Id: build_roms.csh 164 2020-04-30 20:49:18Z arango $
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
setenv ROMS_APPLICATION      DOPPIO

# Set a local environmental variable to define the path to the directories
# where all this project's files are kept.

#setenv MY_ROOT_DIR           /save/COMT
...
# to the code and inputs on differing machines.
 ...
 setenv MY_ROMS_SRC         $TOPDIR/ROMS
 setenv WRF_SRC_DIR         $TOPDIR/WRF
...
#setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -D"
 ...
 setenv MY_CPP_FLAGS "${MY_CPP_FLAGS} -DWRF_NEWTIME"
...
#setenv which_MPI           mvapich2    # compile with MVAPICH2 library
 setenv which_MPI           impi     # compile with OpenMPI library
...
cd $TOPDIR
mv $ROMSEXEC $EXECDIR/${ROMSEXEC}$ROMSSFX
if ( $? == 0 ) then
  rm -Rf Build_${ROMSEXEC}$ROMSSFX
  mv $SCRATCH_DIR Build_${ROMSEXEC}$ROMSSFX
endif
